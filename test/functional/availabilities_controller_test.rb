...
class AvailabilitiesControllerTest < ActionController::TestCase
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post :create, availability: { day_id: @availability.day_id, num_seats: @availability.num_seats, space_id: @availability.space_id }
    end
  ...
  test "should update availability" do
    put :update, id: @availability, availability: { day_id: @availability.day_id, num_seats: @availability.num_seats, space_id: @availability.space_id }
    assert_redirected_to availability_path(assigns(:availability))
  end
